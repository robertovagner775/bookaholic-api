...
public interface AvaliacaoRepository extends JpaRepository<Avaliacao, Long> {
    ...
    @Query("SELECT new com.bookaholic.backend.dto.SelecAvalDto( AVG(a.qtd_estrela) score, COUNT(*) quantidade, l.titulo )  FROM avaliacao a JOIN a.livro l  Group BY l.id_livro, l.titulo ORDER BY a.qtd_estrela  LIMIT 2")
